...
const attach = (0, import_command.declareCommand)({
  ...
  category: "core",
  args: import_zodBundle.z.object({
    name: import_zodBundle.z.string().optional().describe("Bound browser name to attach to")
  }),
  options: import_zodBundle.z.object({
    cdp: import_zodBundle.z.string().optional().describe("Connect to an existing browser via CDP endpoint URL."),
    endpoint: import_zodBundle.z.string().optional().describe("Playwright browser server endpoint to attach to."),
    extension: import_zodBundle.z.union([import_zodBundle.z.boolean(), import_zodBundle.z.string()]).optional().describe("Connect to browser extension, optionally specify browser name (e.g. --extension=chrome)"),
    config: import_zodBundle.z.string().optional().describe("Path to the configuration file, defaults to .playwright/cli.config.json"),
    session: import_zodBundle.z.string().optional().describe('Session name (defaults to bound browser name or "default")')
  }),
...
const install = (0, import_command.declareCommand)({
  ...
  args: import_zodBundle.z.object({}),
  options: import_zodBundle.z.object({
    skills: import_zodBundle.z.string().optional().describe("Install skills, possible values: claude (default), agents.")
  }),
  toolName: "",
  toolParams: () => ({})
});
