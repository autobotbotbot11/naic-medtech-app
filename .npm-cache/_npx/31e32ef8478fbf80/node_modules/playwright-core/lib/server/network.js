...
class Request extends import_instrumentation.SdkObject {
  ...
  async rawRequestHeaders(progress) {
    return await progress.race(this._rawRequestHeaders());
  }
  async response(progress) {
