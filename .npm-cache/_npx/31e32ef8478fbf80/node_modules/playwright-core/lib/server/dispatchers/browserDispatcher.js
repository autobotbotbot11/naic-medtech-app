...
class BrowserDispatcher extends import_dispatcher.Dispatcher {
  ...
  async cleanupContexts() {
    await Promise.all(Array.from(this._isolatedContexts).map((context) => context.close(import_progress.nullProgress, { reason: "Global context cleanup (connection terminated)" })));
  }
}
