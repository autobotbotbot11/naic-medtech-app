...
class AndroidDevice extends import_instrumentation.SdkObject {
  ...
  async _installDriver(progress) {
    ...
    this._shell("am instrument -w com.microsoft.playwright.androiddriver.test/androidx.test.runner.AndroidJUnitRunner").catch((e) => (0, import_utilsBundle.debug)("pw:android")(e));
  ...
  async send(progress, method, params = {}) {
