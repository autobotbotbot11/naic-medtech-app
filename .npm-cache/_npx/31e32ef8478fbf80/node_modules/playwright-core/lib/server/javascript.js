...
class ExecutionContext extends import_instrumentation.SdkObject {
  ...
  async _evaluateWithArguments(expression, returnByValue, values, handles) {
  ...
  _utilityScript() {
    if (!this._utilityScriptPromise) {
      ...
      this._utilityScriptPromise = this.raceAgainstContextDestroyed(this.delegate.rawEvaluateHandle(this, source)).then((handle) => {
...
class JSHandle extends import_instrumentation.SdkObject {
  ...
  async internalEvaluateExpression(expression, options, arg) {
