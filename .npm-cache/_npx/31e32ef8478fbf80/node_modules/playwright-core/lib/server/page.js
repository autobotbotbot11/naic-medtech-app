...
class Page extends import_instrumentation.SdkObject {
  ...
  async _onFileChooserOpened(handle) {
    ...
    const fileChooser = new import_fileChooser.FileChooser(handle, multiple);
  ...
  async reload(progress, options) {
    return this.mainFrame().raceNavigationAction(progress, async () => {
      const [response] = await Promise.all([
        ...
        this.mainFrame().waitForNavigation(progress, true, options),
  ...
  async goBack(progress, options) {
    return this.mainFrame().raceNavigationAction(progress, async () => {
      let error;
      const waitPromise = this.mainFrame().waitForNavigation(progress, false, options).catch((e) => {
        error = e;
        return null;
      });
  ...
  async setFileChooserInterceptedBy(progress, enabled, by) {
...
class Worker extends import_instrumentation.SdkObject {
  ...
  async evaluateExpression(progress, expression, isFunction, arg) {
  ...
  async evaluateExpressionHandle(progress, expression, isFunction, arg) {
