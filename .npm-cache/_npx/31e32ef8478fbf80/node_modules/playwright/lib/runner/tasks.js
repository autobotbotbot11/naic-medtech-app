  ...
  return {
    ...
    setup: async (testRun, errors, softErrors) => {
      if (testRun.config.cliArgs.length) {
        const { testFilter, fileFilter } = (0, import_suiteUtils.createFiltersFromArguments)(testRun.config.cliArgs);
      ...
      if (testRun.config.cliGrep || testRun.config.cliGrepInvert) {
        const grepMatcher = testRun.config.cliGrep ? (0, import_util2.createTitleMatcher)((0, import_util2.forceRegExp)(testRun.config.cliGrep)) : () => true;
        const grepInvertMatcher = testRun.config.cliGrepInvert ? (0, import_util2.createTitleMatcher)((0, import_util2.forceRegExp)(testRun.config.cliGrepInvert)) : () => false;
